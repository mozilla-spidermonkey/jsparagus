...
def prod(body, method_name):
    return Production(body, CallMethod(method_name, list(range(len(body))), "AstBuilder"))
...
class GenTestCase(unittest.TestCase):
        ...
        grammar = Grammar({
            ...
            'stmt': NtDef(('Yield',), [
                ...
                Production(["yield", name, ";"],
                           reducer=CallMethod("yield_stmt", [1], "AstBuilder"),
            ...
            'name': NtDef(('Yield',), [
                ...
                Production(["yield"],
                           CallMethod("yield_as_name", [], "AstBuilder"),
    ...
    def testConvenienceMethodTypeInference(self):
        ...
        reducer = CallMethod("f", [CallMethod("g", [0], "AstBuilder")], "AstBuilder")
