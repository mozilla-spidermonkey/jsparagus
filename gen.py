...
def write_rust_parser(out, grammar, actions, ctns, prods, init_state_map):
    out.write("// THIS FILE IS AUTOGENERATED -- HAHAHAHA\n\n")

    out.write("use parser_runtime::Node;\n\n")
    ...
    out.write(
        "pub fn parse<In: TokenStream>(\n"
        "    mut tokens: In,\n"
        "    start_state: usize,\n"
        ") -> Result<In::Node, &'static str> {\n"
        "    parser_runtime::parse(tokens, start_state, &TABLES, reduce)\n"
        "}\n\n"
    )
