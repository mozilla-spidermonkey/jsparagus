    ...
    ( $macro:ident ! ( ) ) => {
        $macro! {
            [
                ...
                (ThrowSetAliasedConst, throw_set_aliased_const, NULL, 5, 0, 0, JOF_ENVCOORD|JOF_NAME|JOF_DETECTING),
                (ThrowSetCallee, throw_set_callee, NULL, 1, 0, 0, JOF_BYTE),
                (ThrowSetConst, throw_set_const, NULL, 4, 0, 0, JOF_LOCAL|JOF_NAME|JOF_DETECTING),
