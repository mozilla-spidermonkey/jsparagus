...
class RustParserWriter:
    ...
    def parser_trait(self):
        self.write(0, "pub trait<'alloc> Parser {")
        self.write(1, "fn shift(&mut self, sv: StackValue<'alloc>);")
        self.write(1, "fn reduce(&mut self, pop: usize, nt: NonterminalId, value: StackValue<'alloc>) -> Result<'alloc, ()>;")
        ...
        def write_action(indent, act, is_packed):
            ...
            if isinstance(act, Reduce):
                ...
                self.write(indent, "parser.reduce({}, NonterminalId::{}, {})?;",
                           act.pop, self.nonterminal_to_camel(act.nt), value)
                ...
                if act.update_stack():
                    ...
                    for i in range(depth):
                        self.write(indent, "let s{} = parser.pop();", i + 1)
